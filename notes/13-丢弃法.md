...
<img src="../imgs/13/13-06.png"width="400" height="100" alt="13-06" style="zoom: 33%; float: left;" />

+ 随机选中某些神经元将其输出置位0，因此模型不会过分依赖某些神经元

<img src="../imgs/13/13-07.png"width="400" height="100" alt="13-07"  style="zoom: 33%; float: left;" />
