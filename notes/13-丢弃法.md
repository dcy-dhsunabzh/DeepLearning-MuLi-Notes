...
<img src="../imgs/13/13-01.png" alt="13-01" width="400" height="100"style="zoom: 60%; float: left;" />

+ 例如模型的功能是识别猫猫，加入噪音可以是输入模糊的猫猫图片，但尽量不要是狗狗的图片。

### 丢弃法对每个元素作如下扰动

<img src="../imgs/13/13-04.png" alt="13-04" width="400" height="100" style="zoom: 50%; float: left;" />

+ 能够满足加入噪音的期望相同原则

<img src="../imgs/13/13-05.png"alt="13-05" width="400" height="100" style="float: left; zoom: 80%;" />
