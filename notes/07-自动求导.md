...
<img src="C:\Users\admin\Desktop\07-img\image-01" alt="image-20220107231957396" style="zoom:67%;" />
...
<img src="C:\Users\admin\Desktop\07-img\image-02" alt="image-20220107231931153" style="zoom: 80%;" />

---

#####         例1（标量对向量求导）

​                                 <img src="C:\Users\admin\Desktop\07-img\image-03" alt="image-20220107233527373" style="zoom: 67%;" />          



#####          例2（矩阵对矩阵求导）

​                                   <img src="C:\Users\admin\Desktop\07-img\image-04" alt="image-20220107233753066" style="zoom: 67%;" />   
...
- 自动求导有别于
  ...
  - 符号求导
    ...
    ![image-20220107235547201](C:\Users\admin\Desktop\07-img\image-05)

  - 数值求导

    ![image-20220107235611767](C:\Users\admin\Desktop\07-img\image-06)
...
<img src="C:\Users\admin\Desktop\07-img\image-07" alt="image-20220107235918270" style="zoom: 67%;" />
...
- 计算图有两种构造方式
  ...
  - 显示构造
    ...
    ​                                  <img src="C:\Users\admin\Desktop\07-img\image-08" alt="image-20220108000740736" style="zoom:67%;" />
  ...
  - 隐式构造
    ...
    ​                                 <img src="C:\Users\admin\Desktop\07-img\image-09" alt="image-20220108001154208" style="zoom:67%;" />

#### 自动求导的两种模式

- 正向累积

  ​                                        ![image-20220108001506326](C:\Users\admin\Desktop\07-img\image-10)

- 反向累积（反向传递back propagation）

​                                               ![image-20220108001517029](C:\Users\admin\Desktop\07-img\image-11)

   

​    **反向累积计算过程**

<img src="C:\Users\admin\Desktop\07-img\image-12" alt="image-20220108001847175" style="zoom:67%;" />

> 反向累积的正向过程：自底向上，需要存储中间结果
>
> 反向累积的反向过程：自顶向下，可以去除不需要的枝（图中的x应为w）
>
> ​            <img src="C:\Users\admin\Desktop\07-img\image-13" alt="image-20220108002228166" style="zoom:50%;" />
...
![img](C:\Users\admin\Desktop\07-img\image-14)
